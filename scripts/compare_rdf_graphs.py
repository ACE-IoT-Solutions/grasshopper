...
pass_networkx_to_pyvis(nx_graph_in_first, net, node_data_in_first, "red", "bacnet_scan/imgs/minus.png")
pass_networkx_to_pyvis(nx_graph_in_second, net, node_data_in_second, "green", "bacnet_scan/imgs/plus.png")
