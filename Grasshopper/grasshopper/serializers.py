...
class IPAddress(BaseModel):
    ...
    ip_address: str = Field(description="IP address with optional subnet mask (e.g., '192.168.1.1' or '192.168.1.0/24')")
...
class IPAddressList(BaseModel):
    ...
    ip_address_list: List[str] = Field(description="List of IP addresses with optional subnet masks")
...
class MessageResponse(BaseModel):
    ...
    message: str = Field(description="Success message describing the result of the operation")
